# Contribute to Paid Memberships Pro - Add Name To Checkout
...
* Submit a ticket for your issue, assuming one does not already exist.
  * Raise it on our [Issue Tracker](https://github.com/strangerstudios/pmpro-add-name-to-checkout/issues/new/choose)
...
* Finally, please use tabs and not spaces. The tab indent size should be 4 for all Paid Memberships Pro - Add Name To Checkout code.
